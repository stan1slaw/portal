...
Franchise.create!([
                      {name: "Star Wars", description: "about space\r\n", display_in_navbar: true},
                      {name: "Harry Potter", description: "about wizards", display_in_navbar: true},
                      {name: "John Wick", description: "about John", display_in_navbar: true}
                  ])
Film.create!([
                 {name: "Star Wars 7", producer: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam", time_create: "2015-12-17", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. AliquamLorem ipsum dolor sit amet, consectetur adipisicing elit. AliquamLorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam", picture: [Rails.root.join("app/assets/images/star_wars.jpg").open,Rails.root.join("app/assets/images/star1.jpg").open,Rails.root.join("app/assets/images/star2.jpg").open, Rails.root.join("app/assets/images/star3.jpeg").open ], cached_votes_total: 1, cached_votes_score: 1, cached_votes_up: 1, cached_votes_down: 0, cached_weighted_score: 1, cached_weighted_total: 1, cached_weighted_average: 1.0, franchise_id: 1},
                 {name: "Roque One", producer: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam", time_create: "2016-12-10", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. AliquamLorem ipsum dolor sit amet, consectetur adipisicing elit. AliquamLorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam", picture: [Rails.root.join("app/assets/images/roque.jpeg").open,Rails.root.join("app/assets/images/roque1.jpeg").open, Rails.root.join("app/assets/images/roque2.jpeg").open,Rails.root.join("app/assets/images/roque3.jpeg").open ], cached_votes_total: 1, cached_votes_score: 1, cached_votes_up: 1, cached_votes_down: 0, cached_weighted_score: 1, cached_weighted_total: 1, cached_weighted_average: 1.0, franchise_id: 1},
                 {name: "John Wick 3", producer: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam", time_create: "2019-05-09", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. AliquamLorem ipsum dolor sit amet, consectetur adipisicing elit. AliquamLorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam", picture: [Rails.root.join("app/assets/images/john_wick.jpeg").open, Rails.root.join("app/assets/images/john1.jpg").open, Rails.root.join("app/assets/images/john2.jpeg").open, Rails.root.join("app/assets/images/john3.jpeg").open], cached_votes_total: 1, cached_votes_score: -1, cached_votes_up: 0, cached_votes_down: 1, cached_weighted_score: -1, cached_weighted_total: 1, cached_weighted_average: -1.0, franchise_id: 3},
                 {name: "Harry Potter and deathly hallows part 2", producer: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam", time_create: "2012-05-09", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. AliquamLorem ipsum dolor sit amet, consectetur adipisicing elit. AliquamLorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam", picture: [Rails.root.join("app/assets/images/harry_potter.jpg").open, Rails.root.join("app/assets/images/harry1.jpeg").open, Rails.root.join("app/assets/images/harry2.jpeg").open, Rails.root.join("app/assets/images/harry3.jpeg").open], cached_votes_total: 1, cached_votes_score: -1, cached_votes_up: 0, cached_votes_down: 1, cached_weighted_score: -1, cached_weighted_total: 1, cached_weighted_average: -1.0, franchise_id: 2}
             ])
